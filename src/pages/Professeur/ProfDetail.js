...
import './prof.css'; // Assurez-vous d'importer votre fichier de styles CSS
        ...
        <div className="col-md-5 border-right">
          <div className="p-3 py-5">
            <div className="d-flex justify-content-between align-items-center mb-3">
              <h4 className="text-right">Profile de {professeur?.nom.toUpperCase()}</h4>
            </div>
            {/* first box */}
          ...
          <div className="p-3 py-5">
            ...
            <div className="col-md-12">
              ...
              {professeur.matieres.map((mat, index) => (
                <input key={index} type="text" className="form-control my-2" placeholder="matière" value={mat.nom} readOnly />
              ))}
